using ćwiczenie_416_formularz_wymiana_kart;
    ...
    internal class Game
    {
        ...
        public bool PlayOneRound(int selectedPlayerCard)
        {
            ...
            for(int i=0; i< players.Count; i++)
            {
                ...
                {
                    textBoxOnForm.Text += players[i].Name + " ciagnie karty" + Environment.NewLine;
                    int card = 1;
                ...
                if(stock.Count == 0)
                {
                    textBoxOnForm.Text = "Na stercie nie ma żadnych kart. Gra skończona!" + Environment.NewLine;
                    return true;
                }
            }
            return false;
        ...
        public string DescribePlayerHands()
        {
            ...
            description += "Na stercie pozostało kart: " + stock.Count + "\r\n";
            return description;
        }
    }
}
